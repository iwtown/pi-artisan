...
export const ADAPTER_RULES: Record<string, AdapterRule[]> = {
  ...
  skill: [
    ...
    // ── B3: Security — 安全红牌扫描 ──
    {
      id: "skill-sec-curl-ip",
      type: "skill",
      severity: "warning",
      description: "SKILL.md 中 curl/wget 指向 IP 地址而非域名，可能为恶意行为",
      source: "skills: Security — network to IP",
      autoFixable: false,
    },
    {
      id: "skill-sec-credential",
      type: "skill",
      severity: "warning",
      description: "SKILL.md 访问 ~/.ssh, ~/.aws, credential 等敏感路径",
      source: "skills: Security — credential access",
      autoFixable: false,
    },
    {
      id: "skill-sec-base64",
      type: "skill",
      severity: "warning",
      description: "SKILL.md 包含 base64 解码操作，可能为代码混淆",
      source: "skills: Security — base64 decode",
      autoFixable: false,
    },
    {
      id: "skill-sec-eval",
      type: "skill",
      severity: "warning",
      description: "SKILL.md 使用 eval/exec 执行动态代码",
      source: "skills: Security — dynamic code",
      autoFixable: false,
    },
    {
      id: "skill-sec-sudo",
      type: "skill",
      severity: "info",
      description: "SKILL.md 包含 sudo 命令，需确认提权必要性",
      source: "skills: Security — privilege escalation",
      autoFixable: false,
    },
    {
  ...
  extension: [
    ...
    // ── Warning ──
    {
      ...
      type: "extension",
      severity: "warning",
      description: "自定义工具建议使用 namespace_prefix 格式（如 my-ext_tool-name），避免与内置工具命名冲突（不影响加载）",
